import { FilterFunctionEnum, IFilterFunctionDesc, IFilterObject, IFilterProperty, IObjectInfo, 
  IPropertyDescriptor, PropertyTypeEnum, StringHelper } from 'lotus-core';
